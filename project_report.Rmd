...
<div style="text-align: justify">
Based on our findings of the number of patents and the R&D impact in the ranking of most innovative companies, we have run a research to understand the state of art of the initiatives that could foment innovation and help the countries push up their companies on this list. To collect the best insights to achieve this goal we reviewed the literature in a qualitative analysis. Our findings show as the main important constructs to be considered: The Triple Helix Theory, Diversity incentive, and Open Innovation adoption. These constructs are discussed below.
...
According to (Doblinger, Surana et al. 2019), the patenting activity of cleantech start-ups increased by 73.7 percent with every additional governmental technology alliance when compared to those start-ups that did not engage in such alliances. Findings from (Jugend, Jabbour et al. 2018) demonstrate that government support has clear effect on innovation. It shows the positive influence of state policies on how firms collaborate and co-create within a sector, as well as the role of state financial and non-monetary support in improving innovative performance among firms. 
