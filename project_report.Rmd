...
author: by Aïchata Kone, Keila Baesso, & Nicholas McInnis
---
...
* Model 1: $logit(P(indicator_i))=\beta_0+\beta_1.RD+\beta_2.patent$

* Model 2: $logit(P(indicator_i))=\beta_0+\beta_1.(RD)^2+\beta_2.patents$

* Model 3: $logit(P(indicator_i))=\beta_0+\beta_1.RD+\beta_2.(patents)^2$

* Model 4: $logit(P(indicator_i))=\beta_0+\beta_1.RD+\beta_2.patents+\beta_3.(RD.patents)$
